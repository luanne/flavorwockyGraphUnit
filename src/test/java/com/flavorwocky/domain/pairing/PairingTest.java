...
public class PairingTest extends BaseTest {
    ...
    public void testSavePairing() {
        ...
        String ingredientSubgraph = "create (i1:Ingredient {name: 'Prawns'}), (i2:Ingredient {name: 'Garlic'}), (i1)<-[:hasIngredient]-(p:Pairing {affinity: 0.45}), (p)-[:hasIngredient]->(i2) merge (i1)-[:pairsWith]-(i2)";
        ...
        ingredientSubgraph = "create (i1:Ingredient {name: 'Lemon'}), (i2:Ingredient {name: 'Garlic'}), (i1)<-[:hasIngredient]-(p:Pairing {affinity: 0.6}), (p)-[:hasIngredient]->(i2) merge (i1)-[:pairsWith]-(i2)";
